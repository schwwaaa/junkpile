# Raw WebGL Shader · Tauri v2 · Single Window
...
```text
docs/images/webgl-tauri-v2-single-template.png
```

Then replace this section with:

```markdown
![Raw WebGL Shader · Tauri v2 · Single Window running](../../docs/images/webgl-tauri-v2-single-template.png)
```
