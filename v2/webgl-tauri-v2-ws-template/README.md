# Raw WebGL Shader · Tauri v2 · Two-Window WebSocket
...
```text
docs/images/webgl-tauri-v2-ws-template.png
```

Then replace this section with:

```markdown
![Raw WebGL Shader · Tauri v2 · Two-Window WebSocket running](../../docs/images/webgl-tauri-v2-ws-template.png)
```
