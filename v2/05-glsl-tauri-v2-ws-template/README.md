# External GLSL Shader · Tauri v2 · Two-Window WebSocket
...
```text
docs/images/glsl-tauri-v2-ws-template.png
```

Then replace this section with:

```markdown
![External GLSL Shader · Tauri v2 · Two-Window WebSocket running](../../docs/images/glsl-tauri-v2-ws-template.png)
```
