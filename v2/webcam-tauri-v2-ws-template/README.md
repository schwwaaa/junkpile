# Webcam Processing · Tauri v2 · Two-Window WebSocket
...
```text
docs/images/webcam-tauri-v2-ws-template.png
```

Then replace this section with:

```markdown
![Webcam Processing · Tauri v2 · Two-Window WebSocket running](../../docs/images/webcam-tauri-v2-ws-template.png)
```
