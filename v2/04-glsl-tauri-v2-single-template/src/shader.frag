...
// =============================================================================
//
// This file is loaded at runtime via fetch() by app.js.
// To swap the shader while the example is running, use the Load .frag button.
// Restore Default fetches this file again without restarting the application.
//
