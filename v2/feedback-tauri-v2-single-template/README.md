# Ping-Pong Webcam Feedback · Tauri v2 · Single Window
...
```text
docs/images/feedback-tauri-v2-single-template.png
```

Then replace this section with:

```markdown
![Ping-Pong Webcam Feedback · Tauri v2 · Single Window running](../../docs/images/feedback-tauri-v2-single-template.png)
```
