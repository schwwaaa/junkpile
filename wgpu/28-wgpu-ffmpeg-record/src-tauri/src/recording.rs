...
impl FfmpegRecordingSink {
    ...
    pub fn start(
        ...
        let output_path = output_dir.join(output_filename(profile));
...
fn validate_settings(width: u32, height: u32, fps: u32) -> Result<(), String> {
    ...
    if width > 3840 || height > 2160 {
        return Err("this teaching example is limited to 3840 × 2160".into());
    }
...
fn output_filename(profile: RecordingProfile) -> String {
