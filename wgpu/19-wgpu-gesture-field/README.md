# 19.2 verification build

This revision contains the WGSL reserved-keyword correction. The controls window visibly shows **BUILD 19.2 · WGSL KEYWORD FIX**. If that marker is absent, an older project folder is running.
