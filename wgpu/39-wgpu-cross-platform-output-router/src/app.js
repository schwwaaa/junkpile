...
function setSnapshot(next) {
  ...
  byId("statusText").textContent = renderer.lastError || recording.lastError || ndi.lastError || platformShare.lastError || "router running";
  ...
  if (profile) {
    byId("previewDetail").textContent = profile.preview.enabled
