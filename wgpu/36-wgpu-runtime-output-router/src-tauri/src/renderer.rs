    ...
    fn snapshot(&self) -> RuntimeSnapshot {
        RuntimeSnapshot {
            ...
            contract_summary: format!(
                "One native {} × {} authoritative texture feeds the local preview, bounded FFmpeg recorder, and bounded NDI sender independently. A failed or disabled sink does not stop the renderer or the other outputs.",
