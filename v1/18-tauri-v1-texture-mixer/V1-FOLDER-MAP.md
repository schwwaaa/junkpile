...
| 17 | `17-tauri-v1-glsl-shader-playground` | Live GLSL editing, compile diagnostics, uniforms, shader saving, and PNG capture |
| 18 | `18-tauri-v1-texture-mixer` | Dual image/video textures, blend modes, procedural masks, transforms, and frame export |
...
**19 Tauri v1 essentials: Examples 00–18.**
