# Ping-Pong Webcam Feedback · Tauri v1 · Two-Window WebSocket
...
```text
docs/images/feedback-tauri-v1-ws-template.png
```

Then replace this section with:

```markdown
![Ping-Pong Webcam Feedback · Tauri v1 · Two-Window WebSocket running](../../docs/images/feedback-tauri-v1-ws-template.png)
```
